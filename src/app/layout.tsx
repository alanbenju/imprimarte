...
export const metadata: Metadata = {
  title: "Customia | Diseños Personalizados",
  description:
    "Crea tus propios diseños personalizados o abre tu tienda online sin inversión inicial",
};
    ...
    <html lang="es">
      <body className="relative min-h-screen bg-white">
        <Providers>
          <Header />
          <CartDrawer />
          <main className="relative mx-auto max-w-full pt-16">{children}</main>
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li>
                      <a href="/#how-it-works" className="text-blue-700 hover:text-blue-900">
                        Cómo Funciona
                      </a>
                    </li>
                    <li>
