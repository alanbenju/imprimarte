...
const DesignStage: React.FC<DesignStageProps> = ({
  ...
  const rectX =
    productConfig[selectedProduct.id as keyof typeof productConfig].rectPosition.x * scaleFactor;
  const rectY =
    productConfig[selectedProduct.id as keyof typeof productConfig].rectPosition.y * scaleFactor;
  ...
  return (
    <>
      <Stage width={stageWidth} height={stageHeight} ref={stageRef}>
        <Layer>
          {tShirtImage && (
            <KonvaImage image={tShirtImage} width={stageWidth} height={stageHeight} />
          )}
          <Rect
            x={rectX}
            y={rectY}
