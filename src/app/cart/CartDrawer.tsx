...
export const CartDrawer = () => {
  ...
  return (
    <div
      className={`fixed right-0 top-0 h-full w-full transform bg-teal-50 shadow-lg transition-transform duration-300 ease-in-out sm:w-96 ${isCartOpen ? "translate-x-0" : "translate-x-full"
        } z-50`}
